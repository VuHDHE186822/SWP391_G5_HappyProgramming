...
<body>
    <div class="container">
        ...
        <form id="deleteForm" action="<%= request.getContextPath() %>/DeleteUserInfoControl" method="post">
            <input name="username" type="hidden" id="deleteUsername" value="<%= request.getParameter("username") %>" >
            <p>Are you sure you want to deactivate this user: <%= request.getParameter("username") %>?</p>
